...
export default function OrderItem({order,loadCart}) {
   return (
      <>
         {order.products.map((item) => (
            <section key={item.productId} className="flex flex-col md:flex-row md:items-start gap-4 p-4 ">
               ...
               <section className="flex flex-col gap-4 md:w-3/5">
                  ...
                  <button className="bg-blue-600 w-full md:w-2/3 rounded-lg p-2 text-center text-white text-lg md:text-md cursor-pointer hover:opacity-80 active:bg-blue-700" onClick={async ()=>{
