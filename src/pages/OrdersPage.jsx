            ...
            <header className="w-full h-16 md:h-12 bg-blue-500 gap-2 flex justify-between px-4 items-center fixed top-0">
               ...
               <section className="flex items-center gap-1 ">
                  <svg width="40" height="40" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <mask id="mask0_4_22" style={{maskType: "alpha"}} maskUnits="userSpaceOnUse" x="0" y="0" width="46" height="46">
               ...
               <section className="flex flex-grow justify-center">
                  <input className="w-2/3 rounded-tl-md rounded-bl-md text-xs text-gray p-2 bg-white" placeholder="Search" />
                     <button className="flex flex-col justify-center items-center bg-blue-300 rounded-tr-md rounded-br-md px-2">
                        <img className="w-4" src="./images/icons/go-button.svg" />
                     </button>
               </section>
               ...
               <section className="flex gap-2">
                  ...
                  <button className="text-white text-center text-sm border p-1 rounded-md flex items-center">
                     <img className="w-4" src="./images/icons/shopping_cart.svg" />
                        Cart
                  </button>
               </section>
            </header>
               ...
               <section className="border border-gray-300 shadow-md flex flex-col gap-12 md:gap-4">
                  ...
                  <section className="flex flex-col md:flex-row md:items-start gap-4 p-4 ">
                     <img className="w-64 md:w-56 mx-auto" src="./images/products/athletic-cotton-socks-6-pairs.png" />
                        ...
                        <button className="border-2 border-gray-300 w-full md:w-1/3 rounded-lg p-2 text-lg md:text-md">Track Package</button>
                  </section>
